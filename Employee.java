		...
		btnLoadData.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try{
                                    ...
                                    String displayCustomersql = "select name,age,gender,job,salary,phone,adhar,email from employee inner join designation on employee.designation_id=designation.designation_id;";
